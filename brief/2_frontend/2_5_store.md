...
## Catalog & Pricing
  ...
  - Pricing controls: multi-currency (AUD/NZD), GST variations, member vs non-member rates, tiered sponsorship levels, bulk discounts for corporate accounts under guardrails from [Finance & Payments](6_3_payments.md).
...
| Advertisements & Job ads | Shopify + CMS | Requires templated intake forms per [Forms Framework](6_4_forms.md) |
...
| Tickets (awards, conferences) | Eventbrite + Shopify bundles | Pricing logic references [Finance & Payments](6_3_payments.md) |

## Commerce Experience
  - Shopping cart that allows mixed items (entries, tickets, sponsorships) and consolidated checkout with invoice request option.
  - Support purchasing on behalf of others, corporate invoicing, PO numbers, and installment plans for high-value sponsorships, while handoff to [Finance & Payments](6_3_payments.md) covers reconciliation rules.
...
## Integrations & Finance
  - Storefront APIs connect to CMS for storytelling, CRM for eligibility, analytics for performance, and defer all ledger/tax logic to [Finance & Payments](6_3_payments.md) to avoid duplicate documentation.
